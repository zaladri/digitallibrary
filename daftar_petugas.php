            ...
            <div class="card mt-5 mb-5">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <h5> Silahkan Daftar Akun Anda Sebagai Petugas</h5>
                            <form method="post" action="http://localhost/digitallibrary/proses_daftarPetugas.php">
                                ...
                                <div class="form-group mt-2">>
                                    ...
                                    <div class="form-group mt-2">>
                                    <a href="http://localhost/digitallibrary/admin/user/daftar_admin.php" class="link">(<b>Daftar sebagai Admin</b>)</a>
                                </div>
                                </div>
                            </form>
                        </div>
